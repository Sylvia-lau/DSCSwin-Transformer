...
class GradCAM(object):
    ...
    def __call__(self, inputs, index,flag=True):
        """
        ...
        if flag and np.argmax(output.cpu().data.numpy()) != index : return None
        elif flag==False and np.argmax(output.cpu().data.numpy()) == index : return None
