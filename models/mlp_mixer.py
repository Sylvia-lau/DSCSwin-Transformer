...
from .layer.helpers import build_model_with_cfg, overlay_external_default_cfg, named_apply, to_2tuple
from .layer.mlp import  Mlp, GluMlp, GatedMlp
from .layer.patch_embed import PatchEmbed
from .layer.drop import DropPath
from .layer.weight_init import lecun_normal_
from .layer.registry import register_model
...
default_cfgs = dict(
    ...
    resmlp_12_224=_cfg(
        ...
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD),
    resmlp_24_224=_cfg(
        url=r'/data/lyt/neck_region_transformer/weight/resmlp_24_224_raa-a8256759.pth',
    ...
    resmlp_big_24_224=_cfg(
        url=r'/data/lyt/neck_region_transformer/weight/resmlpB_24_no_dist.pth',
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD),
    ...
    resmlp_big_24_distilled_224=_cfg(
        url=r'/data/lyt/neck_region_transformer/weight/resmlpB_24_dist.pth',
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD),
...
def mixer_b16_224(pretrained=False, **kwargs):
    ...
    Paper:  'MLP-Mixer: An all-MLP Architecture for Vision' - https://arxiv.org/abs/2105.01601
    """
    model_args = dict(num_classes=6, img_size=224,patch_size=16, num_blocks=12, embed_dim=768, **kwargs)
