...
from .layer.features import FeatureListNet, FeatureDictNet, FeatureHookNet
from .fx_features import FeatureGraphNet
from .layer.hub import has_hf_hub, download_cached_file, load_state_dict_from_hf
from .layer import Conv2dSame, Linear, BatchNormAct2d
from .layer.registry import get_pretrained_cfg
...
def load_custom_pretrained(
    ...
    pretrained_loc = r'/data/lyt/lymphnode_bm/weight/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz'
...
def load_pretrained(
    ...
    """
    pretrained_cfg = pretrained_cfg or getattr(model, 'pretrained_cfg', None) or {}
    # pretrained_url = r'/data/lyt/lymphnode_bm/weight/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz'
    # params = torch.load(pretrained_url)
